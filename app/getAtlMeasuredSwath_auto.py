...
class atl03Struct:
    ...
    def __init__(self, atl03_lat, atl03_lon, atl03_easting, atl03_northing, 
                 ...
                 gtNum, zone, hemi, kmlRegionName, headerFilePath, truthFilePath, 
        ...
        if(len(badVars)==0):
            ...
            if(os.path.exists(kmlBoundsTextFile)):
                ...
                try:
                    ...
                    writeLog('   Could not read truth header .mat file. Auto-assigning UTM zone.', logFileID)
            ...
            if('auto' in trimMode.lower()):
                ...
                if(kmlRegionName):
                    ...
                    writeLog('   Auto Trim Mode (Trimming Data Based on Truth Region)...', logFileID)
