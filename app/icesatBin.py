...
def create_atl08_bin(atl03_df, atl08, res_at = 30):
    #Create Key DF based on ATL08
    atl03_df = orient_df(atl03_df, 'alongtrack')
    # atl03_df = orient_df(heights_i, 'alongtrack')
...
if __name__ == "__main__":
    if os.name == 'nt':
        ...
        basepath = '/LIDAR/server/USERS/max/1_data/Amy_truth_data/'

    atl03file = 'ATL03_20190915041406_12080402_003_01_nreq_sub_0008.h5'
    atl08file = 'ATL08_20190915041406_12080402_003_01_nreq_sub_0008.h5'
    ...
    df_bin = create_atl08_bin(atl03, atl08, res_at = 200)
